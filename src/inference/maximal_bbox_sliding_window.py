...
class MaximalBBoxSlidingWindow(VideoSlidingWindow):
    def __init__(
        ...
        self.detection_cache = (
            OrderedDict()
        )  # Cache for storing detections by frame index
...
class MaximalBBoxSlidingWindow2(VideoSlidingWindow):
    def __init__(
        ...
        self.ann_iterator = self.detector.predict_detached(
            video=video_path, step=frame_sample_rate
        )
...
class MaximalBBoxSlidingWindow3(VideoSlidingWindow):
    def __init__(
        self,
        video_path: str,
        ...
        self.video_ann = video_ann
        self.frames = [frame for frame in video_ann.frames] if video_ann is not None else []
